...
-- Note: passwords are 'password123' (INSERT INTO users (id, family_id, email, password_hash, name, role, avatar) 
VALUES 
...
UPDATE users SET child_id = 'cccc3333-3333-3333-3333-333333333333' WHERE id = 'aaaa4444-4444-4444-4444-444444444444';ATE users SET child_id = 'cccc2222-2222-2222-2222-222222222222' WHERE id = 'aaaa3333-3333-3333-3333-333333333333';
...
VALUES
('dddd1111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '閱讀好書 20 分鐘', '今天閱讀《哈利波特》並分享精彩片段給媽媽聽。', '智', '中等', 200, 100, 1, 'Wisdom', '每日', '進行中', '2026-06-01', NULL, NULL),
('dddd2222-2222-2222-2222-222222222222', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '自主整理房間與書桌', '玩具放回箱子，書桌整理乾淨，並拖地。', '德', '較難', 400, 200, 2, 'Responsibility', '每日', '待覆核', '2026-06-01', '{"notes": "我把書本排好了，地板也擦得很乾淨！", "photo": "https://images.unsplash.com/photo-1595428774223-ef52624120d2?w=400&q=80"}', NULL),
('dddd3333-3333-3333-3333-333333333333', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '戶外超慢跑 1.5 公里', '去公園慢跑 3 圈，流汗並紀錄時間。', '體', '終極', 800, 400, 3, 'Courage', '每週', '已退回', '2026-05-30', NULL, '請拍張跑步手錶的紀錄照片給爸爸看喔，加油！'),
('dddd4444-4444-4444-4444-444444444444', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '製作一張感謝卡片送給家人', '親手繪製或寫下一張感恩小卡，送給辛苦的家人表達謝意。', '群', '簡單', 100, 50, 1, 'Empathy', '每週', '進行中', '2026-06-01', NULL, NULL),
('dddd5555-5555-5555-5555-555555555555', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '🪙 每日收支記帳與小反思', '記錄今天的花費與收入，並寫下其中一項是『需要』還是『想要』，與家人討論。', '智', '簡單', 100, 50, 1, 'Wisdom', '每日', '進行中', '2026-06-01', NULL, NULL),
('dddd6666-6666-6666-6666-666666666666', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '🪙 家庭「省電節能」小管家', '主動關掉家中未使用的電燈、冷氣或電器，並記錄這一週的節能行為，體會「節流即是開源」的道理。', '德', '簡單', 100, 50, 1, 'Responsibility', '每日', '進行中', '2026-06-01', NULL, NULL),
('dddd7777-7777-7777-7777-777777777777', 'f1111111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', '🪙 認識利息與複利的神奇力量', '向爸媽請教什麼是「利息」與「複利」，模擬若把 100 金幣存入家庭銀行（年利率 10%），三年後會變成多少？寫下計算過程與小發現。', '智', '中等', 200, 100, 1, 'Wisdom', '每週', '進行中', '2026-06-01', NULL, NULL);

-- 5. Seed Inventory
INSERT INTO inventory (id, child_id, card_template_id, name, type, rarity, description, status, date_acquired, expire_at)
VALUES
('eeee1111-1111-1111-1111-111111111111', 'cccc2222-2222-2222-2222-222222222222', 'r_dinner', '晚餐選擇權', '特權卡', 'Rare', '今晚吃什麼？由你來做主！', '未使用', '2026-05-28', '2026-06-04'),
('eeee2222-2222-2222-2222-222222222222', 'cccc2222-2222-2222-2222-222222222222', 'e_date', '爸爸媽媽單獨約會券', '體驗卡', 'Epic', '獲得與爸爸或媽媽單獨出門吃冰淇淋/逛街的下午！', '待核銷', '2026-05-30', '2026-06-29'),
('eeee3333-3333-3333-3333-333333333333', 'cccc2222-2222-2222-2222-222222222222', 'l_title_dragon', '稱號：屠龍勇士', '收藏卡', 'Legendary', '解鎖酷炫角色稱號，展示於個人面板！', '已使用', '2026-05-25', NULL);
...
VALUES
('ffff1111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', '全家日本自由行五天四夜', 10000, 0, TRUE, FALSE),
...
VALUES
('00001111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', '額外遊戲時間 30 分鐘', 'Michelle', '2026-05-29', '已核銷', 'Audrey (媽媽)'),
('00002222-2222-2222-2222-222222222222', 'f1111111-1111-1111-1111-111111111111', '晚餐選擇權', 'Michelle', '2026-05-27', '已核銷', 'Richard (爸爸)');
