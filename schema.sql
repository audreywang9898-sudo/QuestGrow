...
('dddd6666-6666-6666-6666-666666666666', 'f1111111-1111-1111-1111-111111111111', 'cccc1111-1111-1111-1111-111111111111', '🪙 家庭「省電節能」小管家', '主動關掉家中未使用的電燈、冷氣或電器，並記錄這一週的節能行為，體會「節流即是開源」的道理。', '德', '簡單', 100, 50, 1, 'Responsibility', '每日', '進行中', '2026-06-01', NULL, NULL),
('dddd7777-7777-7777-7777-777777777777', 'f1111111-1111-1111-1111-111111111111', 'cccc1111-1111-1111-1111-111111111111', '🪙 認識利息與複利的神奇力量', '向爸媽請教什麼是「利息」與「複利」，模擬若把 100 金幣存入家庭銀行（年利率 10%），三年後會變成多少？寫下計算過程與小發現。', '智', '中等', 200, 100, 1, 'Wisdom', '每週', '進行中', '2026-06-01', NULL, NULL);
